package android.example.textme

import android.app.Activity 
import android.content.Intent
import android.content.SharedPreferences
import android.content.pm.PackageManager
import android.example.textme.Activites.UserInfoActivity
...
import android.example.textme.Constants.AppConstants
import android.example.textme.Permissions.AppPermission
import android.example.textme.Services.SendMediaService
import android.example.textme.Utile.AppUtil
import android.example.textme.databinding.ActivityMessageBinding
import android.example.textme.databinding.LeftItemLayoutBinding
import android.example.textme.databinding.RightItemLayoutBinding
